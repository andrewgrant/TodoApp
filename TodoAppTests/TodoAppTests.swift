...
class TodoAppTests: XCTestCase {
    ...
    func testNewList() {
        ...
        store.saveList(newList, error: &error)
    ...
    func testNewItem() {
        ...
        store.saveItem(newItem, error: &error)
    ...
    func testRemoveList() {
        ...
        store.saveList(newList, error: nil)
        
        newItem.parentUuid = newList.uuid
        store.saveItem(newItem, error: nil)
        ...
        store.removeList(newList, error: nil)
    ...
    func removeItem() {
        ...
        store.removeItem(newItem, error: nil)
