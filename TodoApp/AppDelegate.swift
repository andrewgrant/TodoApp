...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        //TodoStore.sharedInstance.loadDocument()
        
        let notifications = UIUserNotificationSettings(forTypes: UIUserNotificationType.Alert, categories: nil)
        application.registerUserNotificationSettings(notifications)
        application.registerForRemoteNotifications()
        
        TodoStore.sharedInstance.cloudStorage = CloudKit.sharedInstance
        CloudKit.sharedInstance.localStore = TodoStore.sharedInstance
